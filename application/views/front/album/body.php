			...
			<div class="row">
				<!-- <?php foreach($album_all as $album){ ?>
					<div class="col-lg-6">
						...
						<a href="<?php echo base_url('cart/buy/').$album->id_album ?>">
							<?php
				...
				<?php foreach($lapangan_new as $lapangan){ ?>
					<div class="col-lg-6">
						<h4><a href="#"><?php echo $lapangan->nama_lapangan ?></a></h4>
						<a href="<?php echo base_url('cart/buy/').$lapangan->id_lapangan ?>">
							<?php
							if(empty($lapangan->foto)) {echo "<img class='img-responsive' src='".base_url()."assets/images/no_image_thumb.png'>";}
							else { echo " <img class='img-responsive' src='".base_url()."assets/images/lapangan/".$lapangan->foto."'> ";}
							?>
						</a><br>
					</div>
				<?php } ?>
